...
from JProject import message, XError

from StringTemple import *
from Queue import *

class JProjectReleaseCommand( sublime_plugin.WindowCommand ):
    """JProjectReleaseCommand 命令 实现了创建一个完整项目的发行版本"""
    ...
    def __getProjectConfig( self ):
        ...
        with open( self.__configfile, "r" ) as fobj:
            temp += fobj.read()
        temp = re.sub( JProjectReleaseCommand.COMMENT_RE_PATTERN, "", temp  )
